...
class Check
{
     ...
     * @return array
     */
    public function filterNames($firstName, $lastName)
    {
        if ($this->hasProfanity($firstName.$lastName)) {
            $firstName = str_repeat("*", strlen($firstName));
            $lastName  = str_repeat("*", strlen($lastName));
        }
